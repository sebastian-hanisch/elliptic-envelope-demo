...
| Viele Merkmale | ❌ bei 300 Touren Fehlalarmrate 0.03 / 0.02 / 0.03 / 0.04 / 0.08 / 0.16 bei 2 / 5 / 8 / 12 / 20 / 30 Merkmalen; klassischer Recall 0.84 / 0.73 / 0.57 / 0.43 / 0.28 / 0.21. Bei **n ≤ p** markiert keiner der beiden etwas, die Rangfolge ist zufällig (AUC je Datensatz 0.14 bis 0.90) |
